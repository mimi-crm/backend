...
if settings.DEBUG:
    urlpatterns += [
        ...
        path(f"{base_url}/schema/swagger-ui/", SpectacularSwaggerView.as_view(url_name="schema"), name="swagger-ui"),
        path(f"{base_url}/schema/redoc/", SpectacularRedocView.as_view(url_name="schema"), name="redoc"),
    ]
